...
Go through the steps described in setup.md to create your venv, activate it, and get and set your API key, and set your default model to be gpt-5-mini.
...
Update [Results.md](Results.md) with the results of your analysis. Submit that and any code you wrote for your analysis and any output you wish to share from your analysis. 
